        ...
        if (data.length == 0)
            return (
                <ActivityIndicator
                    ...
                    style={{
                        ...
                        height: Dimensions.get('window').height - (56 * 2) - 42 - 24 /*tabbar:56,navigatebar:56,segment:42,statusbar:24*/
                    }}
                />
            )
        else
            return (
                <ScrollView style={styles.container}>
                    ...
                    {data.map((item, i) =>
                        <TouchableOpacity
                            onPress={() => this.props.navigation.navigate('PersonDetailScreen', {person_id: item.id})}
                            key={i}>
